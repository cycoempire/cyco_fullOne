 ...
 * @author wwwki
 */
public class jfSeries_recibo extends javax.swing.JFrame {
    ...
    String ssql;
        ...
        try {
            ...
            ssql = "";
            ssql = ssql + " select * from tserie_recibo";
            ssql = ssql + " where txt_no_serie_recibo = '" + jtxtSerie.getText() +"'";
    ...
    void grabar_serie(){
        ...
        try {
            ...
            int ultimo = vr.recup_ult_numero("tserie_recibo", "id_serie_recibo");
            ...
            if(iProceso == 1){
                CallableStatement cst = cn.prepareCall("{ call sp_grabar_serie_recibo (?,?,?,?)}");
                cst.setInt(1, ultimo);
    ...
    String ssql;
        ...
        try {
            ...
            ssql = "";
            ssql = ssql + " select ts.id_serie_recibo ,ts.txt_no_serie_recibo, ";
            ssql = ssql + " te.txt_desc";
            ssql = ssql + " from tserie_recibo ts";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Series de Recibo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfSeries_recibo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfSeries_recibo().setVisible(true);
            }
        });
    }
